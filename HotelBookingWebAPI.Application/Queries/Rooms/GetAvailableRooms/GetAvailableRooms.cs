...
{
    public class GetAvailableRooms : IRequest<IEnumerable<Room>>
    {
        public GetAvailableRooms(string checkIn, string checkOut, decimal priceNightMin, 
                                    decimal priceNightMax, int roomArea, int peoplePerRoom, 
                                    int numberOfBeds)
        {
